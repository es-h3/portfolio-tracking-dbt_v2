...
, {{to_21_century_date('REPORT_DATE')}} as REPORT_DATE -- DATE
...
{{dbt_utils.surrogate_key(["ACCOUNT_CODE","SECURITY_CODE","SECURITY_NAME","EXCHANGE_CODE","REPORT_DATE","QUANTITY","COST_BASE","POSITION_VALUE","CURRENCY_CODE"])}} as POSITION_HDIFF
, *
